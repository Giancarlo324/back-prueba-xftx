...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2021 at 06:47 AM
...
CREATE TABLE `usuario` (
  ...
  `ultimoingreso` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `intentosfallidos` tinyint(4) NOT NULL DEFAULT 0,
  `cuentanobloqueada` tinyint(4) NOT NULL DEFAULT 1,
  `tiempobloqueado` datetime DEFAULT NULL
